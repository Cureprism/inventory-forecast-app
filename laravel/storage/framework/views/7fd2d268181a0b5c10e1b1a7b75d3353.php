...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <body class="font-sans text-gray-900 antialiased">
        <div class="w-full bg-indigo-600 text-black text-center py-3 text-xl font-semibold tracking-wide">
            商品在庫管理システム
        </div>
...
<?php /**PATH C:\Users\shiny\OneDrive\デスクトップ\my-portfolio\works\inventory-forecast-app\laravel\resources\views/layouts/guest.blade.php ENDPATH**/ ?>